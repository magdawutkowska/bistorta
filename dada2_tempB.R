#A script by Magda Wutkowska, 20190429
...
getwd()
setwd("/Volumes/MetaT_backup/project3/")

# File parsing, IMPORTANT! forward files were treated as reverse, and reverse and forward
pathR <- "/Volumes/MetaT_backup/project3/tempB_FWD"
pathF <- "/Volumes/MetaT_backup/project3/tempB_REV"
...
set.seed(100)
errF <- learnErrors(filtFs, nbases=1e8, multithread=TRUE) #101377979 total bases in 378028 reads from 5 samples will be used for learning the error rates.
errR <- learnErrors(filtRs, nbases=1e8, multithread=TRUE) #101418348 total bases in 378028 reads from 5 samples will be used for learning the error rates.
...
saveRDS(seqtab, "./seqtab_tempB.rds")
#to read it back to R: tempB <- readRDS("./seqtab_tempB.rds")
...
# dim(seqtab.nochim)
# sum(seqtab.nochim)/sum(seqtab) #frequency of chimera seqs 0.95
...
# k__Fungi:1203   p__Ascomycota       :741   c__Agaricomycetes :414  
# p__Basidiomycota    :426   c__Leotiomycetes  :355  
# p__Glomeromycota    :  1   c__Sordariomycetes: 82  
# p__Mortierellomycota:  2   c__Dothideomycetes: 81  
# NA's                : 33   c__Pezizomycetes  : 81  
# (Other)           : 56  
# NA's              :134  
# Order                                  Family   
# o__Helotiales   :332   f__Helotiaceae                  :121  
# o__Agaricales   :168   f__Thelephoraceae               :115  
# o__Thelephorales:115   f__Pyronemataceae               : 74  
# o__Sebacinales  : 94   f__Helotiales_fam_Incertae_sedis: 70  
# o__Pezizales    : 81   f__Hymenogastraceae             : 55  
# (Other)         :239   (Other)                         :473  
# NA's            :174   NA's                            :295  
# Genus                Species   
# g__Tetracladium: 88   s__marchalianum: 51  
# g__Tomentella  : 87   s__acuminata   : 11  
# g__Hebeloma    : 43   s__finlandica  : 11  
# g__Inocybe     : 41   s__decipiens   : 10  
# g__Geopora     : 39   s__albidolutea :  9  
# (Other)        :475   (Other)        :256  
# NA's           :430   NA's           :855  