...
pathR <- "/Users/magdalenawutkowska/Dropbox/PhD/PROJECT_3/r-dada2_test/largeB_FWD"
pathF <- "/Users/magdalenawutkowska/Dropbox/PhD/PROJECT_3/r-dada2_test/largeB_REV"
...
set.seed(100)
errF <- learnErrors(filtFs, nbases=1e8, multithread=TRUE) #100640476 total bases in 385624 reads from 13 samples will be used for learning the error rates.
errR <- learnErrors(filtRs, nbases=1e8, multithread=TRUE) #100761099 total bases in 385624 reads from 13 samples will be used for learning the error rates.
...
saveRDS(seqtab, "./seqtab_largeB.rds")
#to read it back to R: largeB <- readRDS("./seqtab_largeB.rds")
